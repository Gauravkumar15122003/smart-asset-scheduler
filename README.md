# 🔧  Smart Asset Scheduler Airflow-Orchestrated Predictive Maintenance Pipeline with Streamlit Dashboard
...
![Pipeline Running Status](Pic/Pipeline_running_status.png)
